...
tdt_figure=figure('Visible','off','Name',['TDT interface v.001a'],...
    ...
    max(min(OBJ.settings.gui_row_height*ntags,OBJ.settings.gui_height),500)],...
	'NumberTitle','off',...
...
if OBJ.status.buffer_exists
  ...
  button_axis.buffer_status=uicontrol(panel_buffer,'Style','Text',...
    'String',OBJ.buffer_status,...
    'Units','Normalized',...
    'BackgroundColor',panel_background,...
    'ForegroundColor',font_color,...
    'FontSize',fontsize,...
    'Position',[ panel_hor_margin+.11 (1-panel_vert_margin-file_height*2) (1-panel_hor_margin*2) file_height/1.5 ]);
	...
	button_axis.stop_buffer=uicontrol(panel_buffer,'Style','Pushbutton',...
		'String','Stop buffer',...
		'Units','Normalized',...
