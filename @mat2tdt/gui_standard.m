...
status_bar_height=(bottom_pos-.05)./length(status_bar);
...
for i=1:length(status_bar)
	...
	status_axis.(status_id)=uicontrol(tdt_figure,'Style','text',...
			'String',status_text,...
			'Units','Normalized',...
			'Position',[.3 bottom_pos-status_bar_height*i .1 status_bar_height]);

	status_axis.(status_bar{i})=uicontrol(tdt_figure,'Style','text',...
			'String','Circuit loaded: ',...
			'Units','Normalized',...
			'Position',[.405 bottom_pos-status_bar_height*i .1 status_bar_height]);
